      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            ...
            ImportaÃ§Ã£o Universal de Excel
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Importe automaticamente: Animais, IA, FIV, Nascimentos, DiagnÃ³stico de GestaÃ§Ã£o, Notas Fiscais e mais
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              SÃ©rie, RG, Nome, Sexo, RaÃ§a, Data Nascimento, Pai, MÃ£e, Receptora, etc.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Data IA, Touro, Data DG, Resultado (atÃ© 3 inseminaÃ§Ãµes por animal)
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Doadora, LaboratÃ³rio, VeterinÃ¡rio, Data FIV, Quantidade de OÃ³citos
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              SÃ©rie, RG, Data Nascimento, Peso, Tipo (IA/FIV/Natural), Pai, MÃ£e, Receptora
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <div className="flex items-center gap-2 mb-2">
              <CheckCircleIcon className="h-5 w-5 text-green-600" />
              <h3 className="font-semibold text-gray-900 dark:text-white">DiagnÃ³stico de GestaÃ§Ã£o</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              SÃ©rie, RG, Data DG, Resultado (P/N)
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              NÃºmero NF, Tipo, Data, Origem, Destino, Valor Total
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1 list-disc list-inside">
                ...
                <li>Suporta variaÃ§Ãµes de nomes (ex: "Data IA", "DataIA", "data_ia")</li>
                <li>Reconhece mÃºltiplos formatos de data (DD/MM/YYYY, DD-MM-YYYY)</li>
