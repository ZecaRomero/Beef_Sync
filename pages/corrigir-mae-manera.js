...
export default function CorrigirMaeManera() {
  ...
  return (
    <>
      <Head>
        <title>Corrigir Mãe MANERA SANT ANNA | Beef-Sync</title>
      </Head>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              Corrigir Dados da Mãe MANERA SANT ANNA
            </h1>
            
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Esta correção irá atualizar os campos <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">serie_mae</code> e <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">rg_mae</code> de todos os animais que têm "MANERA SANT ANNA" como mãe.
              </p>
              <p className="text-sm text-blue-800 dark:text-blue-200 mt-2">
                Após a correção, as coletas FIV da MANERA SANT ANNA (CJCJ 16013) aparecerão automaticamente na ficha dos filhos.
              </p>
              ...
              <div className="mt-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  ...
                  <div className="mt-3">
                    ...
                    <ul className="text-xs text-green-700 dark:text-green-300 space-y-1">
                      {result.data.animais.map((animal, idx) => (
                        <li key={idx}>
                          • {animal.serie} {animal.rg} - {animal.nome || 'Sem nome'} (Mãe: {animal.mae})
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-green-200 dark:border-green-800">
                  <p className="text-xs text-green-700 dark:text-green-300">
                    💡 Agora você pode recarregar a página da CJCJ 17037 para ver as coletas FIV da mãe!
                  </p>
                </div>
              </div>
            )}
