...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Brucelose desativada no calendário/atividades:
    // somente custos/captações já lançados devem refletir a vacinação.
    const bruceloseComData = []
    ...
    // DGT: machos e fêmeas 330-640 dias
