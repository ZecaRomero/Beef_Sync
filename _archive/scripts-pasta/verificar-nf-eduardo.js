...
async function verificarNFs() {
  try {
    console.log('≈∏‚Äùç Buscando NFs do Eduardo Muniz de Lima...\n')
    ...
    console.log(`≈∏‚Äú‚Äπ Total de NFs encontradas: ${result.rows.length}\n`)
    ...
    result.rows.forEach(nf => {
      ...
      console.log(`  √‚Ä∞ Receptoras: ${nf.eh_receptoras}`)
