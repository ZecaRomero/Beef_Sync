...
async function checkReportData() {
  ...
  try {
    console.log('≈∏‚Äùç Verificando dados para relat√≥rio mensal (2025-09-01 a 2025-10-31)...\n')
    
    // 1. Verificar nascimentos
    console.log('≈∏‚Äò∂ NASCIMENTOS:')
    ...
    console.log('\n≈∏‚Äô∞ VENDAS (animais com situa√ß√£o "Vendido"):')
    ...
    console.log('\n≈∏ê‚Äû TODOS OS ANIMAIS (para debug):')
