 ...
 * - IA com LANDROVES DA XARAES ‚‚Ä†‚Äô Prenha (gesta√ß√£o atual)
 * - IA com REM 11627, JAMANTA ou qualquer outro ‚‚Ä†‚Äô Vazia
 *
...
async function corrigir() {
  console.log('≈∏‚Äùß Corrigindo IAs da CJCJ 15668 (MAESTRA SANT ANNA)\n')
  ...
  try {
    ...
    if (animal.rows.length === 0) {
      console.log('‚ù≈í Animal CJCJ 15668 n√£o encontrado.')
      process.exit(1)
    }
    ...
    console.log('\n   ≈∏‚Äô° Acesse /consulta-animal/239 ou busque CJCJ 15668 para ver o touro correto (LANDROVES DA XARAES) e a previs√£o de parto.')
  } catch (err) {
