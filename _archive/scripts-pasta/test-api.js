...
async function testAPI() {
  console.log('≈∏ß™ Testando API de conectividade...');
  ...
  try {
    ...
    if (data.connected) {
      console.log('‚≈ì‚Ä¶ API conectada com sucesso!');
      console.log('≈∏‚Äú≈† Status:', data.status);
      console.log('≈∏‚Äù‚Äî Configura√ß√£o:');
      ...
      if (data.poolInfo) {
        console.log('≈∏è≈† Pool de Conex√µes:');
      ...
      console.log('‚ù≈í Falha na conectividade da API');
    ...
    console.log('‚ù≈í Erro ao testar API:', error.message);
    console.log('≈∏‚Äô° Certifique-se de que o servidor Next.js est√° rodando (npm run dev)');
  }
}
