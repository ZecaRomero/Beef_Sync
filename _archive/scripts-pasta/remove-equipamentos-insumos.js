...
async function removeEquipamentosInsumosTables() {
  ...
  try {
    console.log('�Ÿ—‘️  Removendo tabelas de equipamentos e insumos...')
    ...
    for (const table of tables) {
      try {
        ...
        console.log(`�œ… Tabela ${table} removida`)
      } catch (error) {
        console.log(`�„�️  Tabela ${table} não existe ou já foi removida`)
      }
    }
    ...
    for (const index of indices) {
      try {
        ...
        console.log(`�œ… Índice ${index} removido`)
      } catch (error) {
    ...
    for (const type of types) {
      try {
        ...
        console.log(`�œ… Tipo ${type} removido`)
      } catch (error) {
    ...
    console.log('�Ÿ“Š Tabelas de equipamentos e insumos foram removidas do banco de dados.')
    
  } catch (error) {
    console.error('�Œ Erro ao remover tabelas:', error.message)
    throw error
  } finally {
    client.release()
    await pool.end()
