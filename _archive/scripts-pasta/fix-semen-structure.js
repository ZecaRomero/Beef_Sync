...
async function fixSemenStructure() {
  ...
  try {
    console.log('≈∏‚Äùß Corrigindo estrutura das tabelas de s√™men...');
    
    // 1. Adicionar colunas faltantes na tabela entradas_semen
    console.log('≈∏‚Äúù Adicionando colunas faltantes...');
    ...
    console.log(`≈∏‚Äú• Migrando ${entradas.rows.length} entradas...`);
    ...
    console.log('‚≈ì‚Ä¶ Estrutura corrigida e dados migrados!');
