...
async function testarAPI() {
  try {
    console.log('≈∏‚Äùç Testando busca de notas fiscais via API...\n')
    ...
    if (nf4393) {
      ...
      console.log(`   ‚ù≈í N√£o encontrada na lista`)
    }

    // Verificar formato dos dados
    console.log('\n≈∏‚Äú‚Äπ Exemplo de dados de uma sa√≠da:')
    if (saidas.length > 0) {
