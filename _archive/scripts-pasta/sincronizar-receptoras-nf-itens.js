...
async function sincronizar() {
  ...
  try {
    ...
    console.log(`�Ÿ“‹ ${itens.rows.length} receptoras encontradas na NF\n`)
    ...
    for (const item of itens.rows) {
      ...
      if (!animal) {
        ...
        criados++
        console.log(`  �œ… Animal criado: ${serie}`)
      } else {
      ...
      if (!teExiste) {
        ...
        teCriadas++
        console.log(`  �Ÿ“… TE criada para ${animal.serie}`)
      }
    }

    console.log('\n=== RESUMO ===')
    console.log(`�œ… Animais criados: ${criados}`)
    console.log(`�Ÿ“… TEs criadas: ${teCriadas}`)
    console.log(`�Ÿ“� Animais atualizados: ${atualizados}`)
    console.log('\n�Ÿ’� As 19 receptoras estão em: Animais > busque "M" ou NF 2141')
