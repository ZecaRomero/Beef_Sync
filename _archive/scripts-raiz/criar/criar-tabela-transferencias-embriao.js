 ...
 * A tabela legada foi removida. N√∆íO execute este script.
 */
...
async function criarTabela() {
  try {
    console.log('≈∏‚Äùß Criando tabela transferencias_embriao...\n')
    ...
    console.log('‚≈ì‚Ä¶ Tabela transferencias_embriao criada com sucesso!\n')

    // Criar √≠ndices para melhor performance
    console.log('≈∏‚Äúù Criando √≠ndices...')
