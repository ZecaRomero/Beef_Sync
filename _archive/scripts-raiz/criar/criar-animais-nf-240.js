...
async function criarAnimaisNF240() {
  ...
  try {
    console.log('≈∏êÆ CRIANDO ANIMAIS DA NF 240 DO MARCELO\n');
    ...
    console.log(`≈∏‚Äú¶ Total de itens: ${itensResult.rows.length}\n`);
    ...
    for (const item of itensResult.rows) {
      try {
        ...
        criados++;
        console.log(`‚≈ì‚Ä¶ ${criados}. ${nome} criado`);
    ...
    console.log(`\n‚≈ì‚Ä¶ Total de animais do Marcelo: ${totalResult.rows[0].total}`);
    console.log('\n≈∏‚Äô° Atualize a tela de Animais (F5) para ver todos!');
