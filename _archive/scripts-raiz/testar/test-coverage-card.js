...
async function testCoverageCard() {
  console.log('ðÅ¸§ª TESTANDO CARD DE COBERTURAS')
  console.log('=' .repeat(50))
  console.log('')

  try {
    // 1. Testar dados bÃ¡sicos
    console.log('1ï¸âÆ’£ DADOS BÃSICOS:')
    ...
    console.log('')
    console.log('2ï¸âÆ’£ DADOS MENSAIS:')
    console.log('-'.repeat(30))
    ...
    console.log('')
    console.log('3ï¸âÆ’£ COBERTURAS RECENTES:')
    console.log('-'.repeat(30))
    ...
    console.log('4ï¸âÆ’£ ESTRUTURA DA API:')
    console.log('-'.repeat(30))
    ...
    console.log('')
    console.log('5ï¸âÆ’£ ESTATÃSTICAS:')
    console.log('-'.repeat(30))
    ...
    console.log('')
    console.log('6ï¸âÆ’£ VERIFICAÃâ€¡ÃÆ’O DE INTEGRIDADE:')
    console.log('-'.repeat(30))
    ...
    if (parseInt(integrityData.sem_tipo) === 0) {
      console.log('âÅ“â€¦ Integridade OK - Todas as gestaÃ§Ãµes tÃªm tipo definido')
    } else {
      console.log('âÅ¡ ï¸ Algumas gestaÃ§Ãµes nÃ£o tÃªm tipo definido')
    }
...
testCoverageCard()
  .then(() => {
    console.log('')
    console.log('ðÅ¸Å½¯ RESULTADO:')
    console.log('ââ‚¬¢ Card de coberturas pronto para uso')
    console.log('ââ‚¬¢ API funcionando corretamente')
    console.log('ââ‚¬¢ Dados de IA e FIV disponÃ­veis')
    console.log('ââ‚¬¢ IntegraÃ§Ã£o com dashboard completa')
    process.exit(0)
  })
  .catch(error => {
