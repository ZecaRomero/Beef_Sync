...
async function testReceptoraImport() {
  console.log('ðÅ¸§ª Testando importaÃ§Ã£o com campo receptora...\n')
  ...
  try {
    ...
    if (result.rows.length > 0) {
      ...
      console.log(`   âÅ“â€¦ Animal inserido com sucesso!`)
    ...
    if (searchResult.rows.length > 0) {
      ...
      console.log(`   âÅ“â€¦ Animal encontrado:`)
      console.log(`   ID: ${animal.id}`)
    ...
    console.log(`   âÅ“â€¦ Animal criado via databaseService:`)
    ...
    console.log(`   âÅ“â€¦ Dados de teste removidos`)

    console.log('\nâÅ“â€¦ Teste concluÃ­do com sucesso!')
    console.log('\nðÅ¸Å½¯ RESULTADO: O sistema estÃ¡ funcionando corretamente para salvar receptora')

  } catch (error) {
    console.error('âÅ’ Erro durante teste:', error)
...
testReceptoraImport()
  .then(() => {
    console.log('\nðÅ¸â€ PRÃâ€œXIMO PASSO: Verificar os dados originais da importaÃ§Ã£o do CJCC 1')
    process.exit(0)
  })
  .catch(error => {
