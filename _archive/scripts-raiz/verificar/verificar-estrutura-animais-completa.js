...
async function verificarEstrutura() {
  try {
    console.log('≈∏‚Äùç Verificando estrutura da tabela animais...\n');
    ...
    if (animal.rows.length > 0) {
      ...
      if (similares.rows.length > 0) {
        console.log('\n≈∏‚Äú‚Äπ RGs similares encontrados:');
