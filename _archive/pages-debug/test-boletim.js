...
export default function TestBoletim() {
  ...
  const loadAnimals = () => {
    try {
      ...
      console.log('≈∏‚Äùç Animais carregados:', animalsData.length)
    } catch (error) {
  ...
  const testBoletim = async () => {
    try {
      ...
      // Verificar se animals √© um array v√°lido
      if (!Array.isArray(animals) || animals.length === 0) {
        alert('‚ù≈í Nenhum animal encontrado. Carregue alguns animais primeiro.')
        return
      }
      ...
      console.log('≈∏ß™ Testando boletim com dados:', {
      ...
      alert('‚≈ì‚Ä¶ Boletim de teste gerado com sucesso!')
      
    } catch (error) {
      console.error('Erro ao testar boletim:', error)
      alert('‚ù≈í Erro ao gerar boletim de teste: ' + error.message)
    } finally {
      setLoading(false)
    }
  }
  ...
  const analyzeAnimals = () => {
    ...
    console.log('≈∏‚Äùç An√°lise dos animais:', analysis)
  }
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><strong>Ra√ßas √≈°nicas:</strong> {new Set(animals.map(a => a.raca)).size}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-green-800 dark:text-green-200">Ra√ßas √≈°nicas</h3>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <p><strong>Receptora:</strong> N√£o aparece no boletim</p>
                <p><strong>Causa:</strong> Verificar dados e c√°lculos</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            >
              ≈∏‚Äò‚Ç¨ Voltar para Contabilidade
            </a>
          </div>
        </div>
        ...
        {animals.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
              ≈∏‚Äú‚Äπ Animais Cadastrados ({animals.length})
            </h2>
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                  {Array.isArray(animals) && animals.length > 0 ? animals.map((animal) => {
                    ...
                    const dataNasc = animal.dataNascimento || animal.data_nascimento || 'N√£o informado'
                    
                    return (
                      <tr key={identificacao} className="border-b">
                        <td className="px-4 py-2">{identificacao}</td>
                        <td className="px-4 py-2">{animal.raca || 'N√£o informado'}</td>
                        <td className="px-4 py-2">{animal.sexo || 'N√£o informado'}</td>
        ...
        {testResults && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
              ≈∏‚Äùç Resultados da An√°lise
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">≈∏‚Äú≈† Resumo</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">≈∏è∑Ô∏è Por Ra√ßa</h3>
                <div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg text-sm">
            ...
            {testResults.semDataNascimento.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">‚≈°†Ô∏è Animais Sem Data de Nascimento</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">≈∏‚Äú‚Ä¶ Idades Calculadas</h3>
